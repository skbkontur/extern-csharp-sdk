...
namespace Kontur.Extern.Api.Client.ApiLevel.Json.Converters.Docflows
{
    public static class DocflowDescriptionTypes
    {
        private static readonly Dictionary<DocflowType, Type> DescriptionTypesMap = new()
        {
            ...
            [DocflowType.Fss.Sedo.SickReportChangeNotification] = typeof(FssSedoSickReportChangeNotificationDescription),
            [DocflowType.Fss.Sedo.FssSedoInsuredPersonRegistration] = typeof(FssSedoInsuredPersonRegistrationDescription),
            [DocflowType.Fss.Sedo.FssSedoInsuredPersonRegistrationResult] = typeof(FssSedoInsuredPersonRegistrationResultDescription),
            [DocflowType.Fss.Sedo.FssSedoProactivePaymentsDemand] = typeof(FssSedoProactivePaymentsDemandDescription),
            [DocflowType.Fss.Sedo.FssSedoProactivePaymentsReply] = typeof(FssSedoProactivePaymentsReplyDescription),
            [DocflowType.Fss.Sedo.FssSedoProactivePaymentsReplyResult] = typeof(FssSedoProactivePaymentsReplyResultDescription),
            [DocflowType.Fss.Sedo.FssSedoProactivePaymentsBenefit] = typeof(FssSedoProactivePaymentsBenefitDescription),
            [DocflowType.Fss.Sedo.FssSedoInsuredPersonMismatch] = typeof(FssSedoInsuredPersonMismatchDescription),
