...
namespace Kontur.Extern.Api.Client.ApiLevel.Clients.Accounts
{
    ...
    public interface IAccountClient
    {
        ...
        /// <param name="isShowBlocked">Получать в ответе заблокированные учетные записи, или нет</param>
        /// <returns>Список учетных записей</returns>
        Task<AccountList> GetAccountsAsync(int? skip = null, int? take = null, TimeSpan? timeout = null, bool isShowBlocked = false);
        ...
        Task<Account> GetAccountAsync(Guid accountId, TimeSpan? timeout = null, bool isShowBlocked = false);
        ...
        Task<Account?> TryGetAccountAsync(Guid accountId, TimeSpan? timeout = null, bool isShowBlocked = false);
