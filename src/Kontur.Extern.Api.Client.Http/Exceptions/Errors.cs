...
namespace Kontur.Extern.Api.Client.Http.Exceptions
{
    internal static class Errors
    {
        ...
        public static Exception TimeSpanOutOfRange([InvokerParameterName] string paramName, TimeSpan actualValue, TimeSpan? lowBound = null, TimeSpan? highBound = null) =>
            new ArgumentOutOfRangeException(
                paramName,
                actualValue,
                $"The duration interval should be within range [{lowBound?.ToString() ?? "-infinity"}, {highBound?.ToString() ?? "+infinity"}]");
