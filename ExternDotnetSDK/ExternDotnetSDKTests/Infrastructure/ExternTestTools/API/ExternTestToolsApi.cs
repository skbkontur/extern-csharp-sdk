...
namespace Kontur.Extern.Client.Tests.Infrastructure.ExternTestTools.API
{
    public class ExternTestToolsApi : IExternTestToolsApi
    {
        ...
        public ExternTestToolsApi(Configuration configuration)
        {
            Configuration = configuration;
            restClient = new RestClient(Configuration.BasePath) {Timeout = Configuration.Timeout, UserAgent = Configuration.UserAgent};
        ...
        public async Task<ApiResponse<CreateTestUsersResponseDto>> CreateAsync(CreateTestUsersRequestDto createTestUsersRequestDto = null)
        {
        ...
        public async Task<ApiResponse<CreateExternAccountResponseDto>> CreateExternAccountIndividualAsync(CreateExternAccountIndividualRequestDto requestDto = null)
        {
        ...
        public async Task<ApiResponse<CertificateAndPrivateKey>> GenerateCertificateAsync(GenerateCertificateRequest generateCertificateRequest = null)
        {
        ...
        public async Task<ApiResponse<Docflow>> GenerateCuLetterAsync(GenerateCuLetterRequest generateCuLetterRequest = null)
        {
        ...
        /// <returns>Task of ApiResponse (Docflow)</returns>
        public async Task<ApiResponse<Docflow>> GenerateDemandAsync(GenerateDemandRequest generateDemandRequest = null)
        {
        ...
        public async Task<ApiResponse<DocflowsSuite>> GenerateDocflowsSuiteAsync(GenerateDocflowsSuiteRequest generateDocflowsSuiteRequest = null)
        {
        ...
        /// <returns>Task of ApiResponse (Docflow)</returns>
        public async Task<ApiResponse<Docflow>> GenerateFnsAsync(GenerateFnsReportRequest fnsReportRequest = null)
        {
        ...
        /// <returns>Task of ApiResponse (string)</returns>
        public async Task<ApiResponse<string>> GenerateFufEnvdAsync(GenerateFufRequest generateFufRequest = null)
        {
        ...
        public async Task<ApiResponse<NdsWithAttachments>> GenerateFufNdsWithAttachmentsAsync(GenerateFufRequest generateFufRequest = null)
        {
        ...
        /// <param name="generateFufRequest">Данные об организации, которая будет оправлять документ в налоговый орган (optional)</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async Task<ApiResponse<string>> GenerateFufProfitTaxAsync(GenerateFufRequest generateFufRequest = null)
        {
        ...
        /// <param name="generateFufRequest">Данные об организации, которая будет оправлять документ в налоговый орган (optional)</param>
        /// <returns>Task of ApiResponse (string)</returns>
        public async Task<ApiResponse<string>> GenerateFufSschAsync(GenerateFufRequest generateFufRequest = null)
        {
        ...
        public async Task<ApiResponse<XmlCalendar>> GenerateXmlCalendarAsync()
        {
