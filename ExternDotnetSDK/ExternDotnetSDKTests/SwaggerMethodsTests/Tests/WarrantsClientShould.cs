...
namespace ExternDotnetSDKTests.SwaggerMethodsTests.Tests
{
    ...
    internal class WarrantsClientShould : AllTestsShould
    {
        ...
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Warrants.GetWarrantsAsync(Guid.NewGuid()));
        }
        ...
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Warrants.GetWarrantsAsync(Account.Id, skip, take));
        }
    }
}