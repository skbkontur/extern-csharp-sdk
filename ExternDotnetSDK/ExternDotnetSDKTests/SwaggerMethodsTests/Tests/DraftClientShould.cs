...
namespace KeApiClientOpenSdkTests.SwaggerMethodsTests.Tests
{
    ...
    internal class DraftClientShould : AllTestsShould
    {
        ...
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CreateDraftAsync(Account.Id, null));
        }
        ...
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CheckDraftAsync(Account.Id, Guid.Empty));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CheckDraftAsync(Guid.Empty, draft.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.PrepareDraftAsync(Account.Id, Guid.Empty));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.PrepareDraftAsync(Guid.Empty, draft.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.SendDraftAsync(Account.Id, Guid.Empty));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.SendDraftAsync(Guid.Empty, draft.Id));
        }

        [Test]
        public void FailToCheckAndPrepareAndSendNotDeferredDraft_WithDocumentsWithoutContent()
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CheckDraftAsync(Account.Id, draft.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.PrepareDraftAsync(Account.Id, draft.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.SendDraftAsync(Account.Id, draft.Id));
        }
        ...
        public async Task FailToCheckAndPrepareAndSendDraft_WithoutDocuments()
        {
            ...
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CheckDraftAsync(Account.Id, d.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.PrepareDraftAsync(Account.Id, d.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.SendDraftAsync(Account.Id, d.Id));
        ...
        {
            var d = await CreateDraftAsync();
            Assert.DoesNotThrowAsync(async () => await Client.Drafts.StartCheckDraftAsync(Account.Id, d.Id));
            await DeleteDraftAsync(d);
        }
        ...
        {
            var d = await CreateDraftAsync();
            Assert.DoesNotThrowAsync(async () => await Client.Drafts.StartPrepareDraftAsync(Account.Id, d.Id));
            await DeleteDraftAsync(d);
        }
        ...
        {
            var d = await CreateDraftAsync();
            Assert.DoesNotThrowAsync(async () => await Client.Drafts.StartSendDraftAsync(Account.Id, d.Id, true));
            await DeleteDraftAsync(d);
        }
        ...
        {
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.GetDraftTasks(Guid.Empty, draft.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.GetDraftTasks(Account.Id, Guid.Empty));
        }
        ...
        {
            var d = await CreateDraftAsync();
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CloudSignDraftAsync(Guid.Empty, d.Id));
            Assert.ThrowsAsync<HttpRequestException>(async () => await Client.Drafts.CloudSignDraftAsync(Account.Id, Guid.Empty));
            await DeleteDraftAsync(d);
        }
